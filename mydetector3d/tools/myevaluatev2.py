...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/student/varsha/3DDepth/mydetector3d/tools/cfgs/waymokitti_models/centerpoint_second.yaml', help='specify the model config')
    ...
    parser.add_argument('--ckpt', type=str, default='/home/student/models/waymokitti_models/centerpoint_second/varsha2/ckpt/latest_model.pth', help='checkpoint to evaluate')
    parser.add_argument('--tag', type=str, default='varsha', help='rag name')
    parser.add_argument('--outputpath', type=str, default='/home/student/data', help='output path')
