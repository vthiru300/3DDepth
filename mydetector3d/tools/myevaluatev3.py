...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/student/varsha/3DDepth/mydetector3d/tools/cfgs/waymokitti_models/second.yaml', help='specify the model config')
    ...
    parser.add_argument('--ckpt', type=str, default='/home/student/models/waymokitti_models/second/varsha/ckpt/latest_model.pth', help='checkpoint to evaluate')
    parser.add_argument('--tag', type=str, default='varsha', help='tag name')
